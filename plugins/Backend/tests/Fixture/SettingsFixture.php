...
class SettingsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'default' => ['type' => 'string', 'length' => 255, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'modified' => '2018-07-17 10:56:28',
                'created' => '2018-07-17 10:56:28'
            ],
        ];
        parent::init();
    }
