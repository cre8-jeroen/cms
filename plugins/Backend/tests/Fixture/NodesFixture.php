...
class NodesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'public' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'public' => 1,
                'modified' => '2018-07-02 18:29:33',
                'created' => '2018-07-02 18:29:33'
            ],
        ];
        parent::init();
    }
